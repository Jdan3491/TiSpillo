...
class Translations extends ChangeNotifier {
  ...
  Map<String, String> _localizedStrings = {}; // Init Map Empty
  String _currentLanguage = 'IT'; // Default ITA language
  ...
  Future<void> loadLanguage([String? languageCode]) async {
    ...
    try {
      String jsonString = await rootBundle.loadString('assets/l10n/intl_$_currentLanguage.arb');
